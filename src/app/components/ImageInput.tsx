  ...
  return (
    <div className="relative">
      <label htmlFor="image">
        ...
        <span className="text-[10px] text-[#282828] font-medium px-2">
      ...
      <input
        ...
        minLength={2}
        maxLength={3}
        className="hidden border border-[#d9d9d9] rounded-[10px] text-[#282828] bg-white w-full h-[50px] outline-none px-3"
        onChange={handleImageChange}
      />
      {states?.errors?.image_1 && (
